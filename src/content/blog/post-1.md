...
Hubo un semestre que también trabajé durante las noches como mesero y bartender en un restaurant llamado Broo cerca de mi casa. Obviamente este trabajo no duró mucho ya que trabajar doble turno e ir a la universidad era insostenible, pero siempre me gustaron los trabajos sociales en donde el contacto con la gente y la buena onda era algo que me caracterizaba para desempeñarlos.
...
.post-contenido {
  ...
  /* 1. ESTILO PARA TODOS LOS H3 (Los manuales) */
  .post-contenido h3 {
    font-weight: normal; /* Asegura que NO sean negrita */
    font-size: 1.3rem;
    margin-top: 1.5rem;
  ...
  /* 2. ESTILO SOLO PARA EL PRIMER H3 (El que viene de ###) */
  .post-contenido h3:first-of-type {
    font-weight: bold; /* SOLO este será negrita */
    font-size: 1.6rem;
    margin-bottom: 1rem;
    color: #1a1a1a;
  }
